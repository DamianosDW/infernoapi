...
{
    public static int getPrivateChannelActivity(int channelNumber, SpActivityCheck spActivity)
    {
    ...
    public static int getCandidatesPrivateChannelActivity(int channelNumber, CandidatesSpActivityCheck spActivity)
    {
        switch(channelNumber)
        {
            case 1:
